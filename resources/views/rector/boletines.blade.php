...
<head>
    <meta charset="UTF-8">
    <title>Rector - Consultar boletines</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    {{-- Bootstrap y FontAwesome simples --}}
...
<div class="container mb-5">
    ...
    {{-- Filtro curso / estudiante --}}
    <form method="GET" action="{{ route('rector.boletines') }}" class="row g-3 mb-4">
        <div class="col-md-4">
    ...
    @if($estudianteSeleccionado)
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <strong>Boletines de: {{ $estudianteSeleccionado->name }}</strong>
            </div>
            <div class="card-body">
                {{-- Aquí luego podrás imprimir los boletines reales --}}
                <p class="text-muted">
                    Aquí se mostrarían los boletines del estudiante (por periodo / año).
                    Por ahora es un espacio listo para conectar con tu tabla de boletines.
                </p>
            </div>
        </div>
    @else
        <p class="text-muted">
            Selecciona un curso y un estudiante para ver sus boletines.
        </p>
    @endif
</div>
